    ...
    <View style={[styles.mainHeader, globalStyles.horizontalGeneralPadding]}>
      ...
      {props.leftIcon && (
        <View style={{marginRight: horizontalScale(20)}}>
          <Button style={{backgroundColor:'transparent'}} onPress={() => props.onLeftIconPress()} >
            {props.leftIcon}
          </Button>
        </View>
      )}
      ...
      <View style={{marginLeft: horizontalScale(20)}}>
        <Button style={{backgroundColor:'transparent'}} onPress={() => props.onRightIconPress()} transparent>
          {props.rightIcon}
        </Button>
      </View>
      {/*--Right Icon End--*/}
